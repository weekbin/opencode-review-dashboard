...
function showHelpModal(): void {
  ...
  dialog.innerHTML = `<h3 id="help-modal-title">${escapeHtml(t("help.modal.title"))}</h3><p class="help-intro">${escapeHtml(t("help.modal.intro"))}</p><div class="help-grid"><div class="help-row"><kbd>n</kbd><span>${escapeHtml(t("help.shortcut.nextFinding"))}</span></div><div class="help-row"><kbd>p</kbd><span>${escapeHtml(t("help.shortcut.prevFinding"))}</span></div><div class="help-row"><kbd>Ctrl+F</kbd> / <kbd>Cmd+F</kbd><span>${escapeHtml(t("help.shortcut.findInDiff"))}</span></div><div class="help-row"><kbd>/</kbd><span>${escapeHtml(t("help.shortcut.findInDiffAlt"))}</span></div><div class="help-row"><kbd>Cmd+P</kbd> / <kbd>Ctrl+P</kbd><span>${escapeHtml(t("help.shortcut.fileJump"))}</span></div><div class="help-row"><kbd>Cmd+/</kbd> / <kbd>Ctrl+/</kbd><span>${escapeHtml(t("help.shortcut.help"))}</span></div><div class="help-row"><kbd>Enter</kbd><span>${escapeHtml(t("help.shortcut.submit"))}</span></div><div class="help-row"><kbd>Esc</kbd><span>${escapeHtml(t("help.shortcut.close"))}</span></div><div class="help-row"><kbd>Tab</kbd><span>${escapeHtml(t("help.shortcut.tabFocus"))}</span></div><div class="help-row"><kbd>?</kbd><span>${escapeHtml(t("help.shortcut.helpAlt"))}</span></div></div><div class="modal-actions"><button id="help-close" class="primary" type="button">${escapeHtml(t("help.modal.close"))}</button></div>`;
