...
## What this round actually has (4 files)
- decision.md
- post-exec.md
- retro.md
- self-check.md
...
## Why missing
R28 was a lead-direct round (v5.3.3 model). Lead-direct takes over 14/15 phases inline
...
- Decision: .omo/round-28/decision.md
- Commit: #58 (1 fix)
