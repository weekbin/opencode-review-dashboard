...
## What this round actually has (2 files)
- decision.md
...
## Why missing
R23 was a lead-direct round (v5.3.3 model). Lead-direct takes over 14/15 phases inline
...
- Decision: .omo/round-23/decision.md
- Commit: #49 + #50 (2 fixes, worst gap)
