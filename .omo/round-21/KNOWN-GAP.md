...
## Why missing
R21 was a lead-direct round (v5.3.3 model). Lead-direct takes over 14/15 phases inline
...
- Decision: .omo/round-21/decision.md
- Commit: fix(tooling): #43 + #44 + #45 (3 fixes)
