...
## What this round actually has (5 files)
- decision.md
...
## Why missing
R31 was a lead-direct round (v5.3.3 model). Lead-direct takes over 14/15 phases inline
...
- Decision: .omo/round-31/decision.md
- Commit: #62 + #63 (2 fixes, bilingual drift)
