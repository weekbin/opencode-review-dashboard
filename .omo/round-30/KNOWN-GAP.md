...
## Why missing
R30 was a lead-direct round (v5.3.3 model). Lead-direct takes over 14/15 phases inline
...
- Decision: .omo/round-30/decision.md
- Commit: #60 + #61 (2 fixes, husky automation false-positive)
